        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="card card-primary">
              ...
              ?> 
                <form method="POST" action="<?php echo base_url();?>generate/doLogin" id="theForm" class="needs-validation" novalidate="">
            ...
            <div class="text-muted text-center">
              <a href="<?php echo base_url('generate/register');?>">Register</a> | <a href="http://www.camlis.net">Camlis</a>
            </div>
          </div>
        </div>
      </div>
