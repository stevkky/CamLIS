		...
		<div class="form-vertical"> 
			<div class="row"> 
                ...
                <div class="col-sm-4">
					...
					<div>
						<button type="button" id="btnPreviewAMR" class="btn btn-primary"><?php echo _t('report.filter'); ?>&nbsp;&nbsp;
                    	<i class="fa fa-search"></i></button>
                        <button type="button" id="btnPrintAMR" disabled class="btn btn-primary"><?php echo _t('report.print'); ?>&nbsp;&nbsp;
    	...
    	<div class="row adm_lab_btnWrapper">
            <div class="col-sm-12">
                ...
                <div id="header" class="printable" style="height:110px; display:none"> 
                  ...
                  <div class="printable" style="display:none; text-align:center; margin-top:0px; font-size:18px; "> TOTAL NUMBER MICROBIOLOGY TESTING
                  ...
                  <div class="printable">
                    <table class="table table-bordered table-striped" id="tbl-aggregated">
                        <!--thead> 
                            ...
                            <th><?php echo _t('report.total'); ?></th>
                        </thead-->
                        <tbody id="tbody_data_amr">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		$(document).on('click', '#btnPrintAMR', function(){
			//
