		...
		<div class="form-vertical"> 
			<div class="row"> 
                ...
                <div class="col-sm-4">
					...
					<div>
						<button type="button" id="btnPreviewRejection" class="btn btn-primary"><?php echo _t('report.filter'); ?>&nbsp;&nbsp;
    	...
    	<div class="row adm_lab_btnWrapper">
            <div class="col-sm-12">
                ...
                <div id="header" class="printable" style="height:110px; display:none"> 
                  ...
                  <div class="printable" style="display:none; text-align:center; margin-top:0px; font-size:18px; "> REPORT BY SAMPLE REJECTION
