    ...
    <div class="modal-footer">
        <div class="row form-horizontal">
            <div class="col-sm-1 text-left">
                <button disabled type="button" class="btn btn-success btn-print"><i class="fa fa-print"></i>&nbsp;<?php echo _t('global.print'); ?></button>
            </div>
            <label class="control-label col-sm-2"><?php echo _t('request.test_payment'); ?></label>
            <div class="col-sm-2 text-left">
                ...
                <span style="display: inline-block; padding-top: 7px;"><?php echo _t('request.riel'); ?></span>
            </div>
            <div class="col-sm-7 text-right">
                <button type="button" class="btn btn-primary btn-assign-test">
                    <i class="fa fa-check-square-o" aria-hidden="true"></i>&nbsp;<?php echo _t('request.assign_test'); ?>
                </button>
                <!--==========================================================================================================
