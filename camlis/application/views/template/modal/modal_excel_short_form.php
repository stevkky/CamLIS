...
<div class="modal fade modal-primary modal-wide fixed-footer" id="modal_excel_short_form" >
		...
		<div class="modal-content">
			...
			?>
					...
					<div class="col-sm-7 text-right">
						<button type="button" class="btn btn-primary" id="btnSaveListShorFormTest"><i class="fa fa-floppy-o"></i>&nbsp;
