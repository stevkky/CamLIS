	...
	<div class="modal-dialog modal-md">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title new"><?php echo _t('admin.add_new_department'); ?></h4>
				<h4 class="modal-title edit" style="display: none;"><?php echo _t('admin.edit_department'); ?></h4>
			</div>
				...
				<div>
					<div class="form-vertical">
						<div class="row form-group">
							<div class="col-sm-12">
								<label for="department_name" class="control-label"><?php echo _t('admin.department_name'); ?> <sup class="fa fa-asterisk" style="font-size: 8px;"></sup></label>
