...
<body>
    ...
    <tbody>
        ...
        <!-- 13-07-2021-->
        <tr>
            <td width="162" valign="top" rowspan="2">
            ...
            <td width="594" colspan="6" style="padding: 0;" valign="top">
                <table class="tbl_vaccine" id="tbl_vaccine">
                    <tr>
                        <td width="170" colspan="2" style="border-bottom: 1px solid #000 !important;">
                        <?php 
                            $checked_0 = "";
                            $checked_1 = "";
                            $checked_2 = "";
                            ...
                            if(!empty($patient_info["vaccination_status"])){
                                if($patient_info["vaccination_status"] == 1){
                                    ...
                                    $checked_3 = "checked";
                                }else if($patient_info["vaccination_status"] == 5){
                                    $checked_4 = "checked";
                                }
                            }
                        ?>
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" value="" readonly <?php echo $checked_4; ?> />
                            <label class="form-check-label">លើកទី៤<br /><small><i>4 doses</i></small></label>
                        </div>
                        </td>
                        <td width="90">
                        ...
                        <td with="90">
                        <p>ថ្ងៃចាក់លើកទី៤<br/> <small><i>4<sup>th</sup> injection date</i>:</small></p>
                            <?php
                                if(!empty($patient_info['forth_vaccinated_date'])){
                                    $forth_vaccinated_date = DateTime::createFromFormat('Y-m-d', $patient_info['forth_vaccinated_date']);
                                    echo $forth_vaccinated_date ? $forth_vaccinated_date->format('d-M-Y') : 'N/A';
                                }
                            ?>
                        </td>                                               
                    </tr>
                    <tr>
                        ...
                        <span>ប្រភេទវ៉ាក់សាំង</span>
                            <?php
                                ...
                                $third_vaccine_id = empty($patient_info['third_vaccine_id']) ? "" : $patient_info['third_vaccine_id'];
                                foreach($vaccines as $item){
                                    if($item->id == $vaccine_id || $item->id == $second_vaccine_id || $item->id == $third_vaccine_id){
