$(function() {
    ...
    $("#btnGenerate").on("click", function(evt) {
        ...
        var url = base_url + "audit_user/report/" + start_date.format("YYYY-MM-DD") + "/" + start_time.format("HH:mm") + "/" + end_date.format("YYYY-MM-DD") + "/" + end_time.format("HH:mm");
        ...
        $.ajax({
            ...
            success: function(resText) {
                ...
                $preview_modal.find("#doPrinting").off("click").on("click", function (evt) {
                    evt.preventDefault();
                    var laboratories = $('#laboratories').val();
                    printpage(url + "/print/" + laboratories.join('-'));
                });
    ...
    $("#btnExportExcel").on("click", function(evt) {
        ...
        audit_user.attr('action', url + "/excel");
        audit_user.attr('method','POST');
        audit_user.submit();
    });
});