...
$(function () {
    ...
    var $modal_reason_comment   = $("#modal-reason-comment"); //30032022
    ...
    $patient_info_form.find("#first_vaccinated_date").datetimepicker(dtPickerOption); //12072021
    $patient_info_form.find("#second_vaccinated_date").datetimepicker(dtPickerOption); //15072021
    $patient_info_form.find("#third_vaccinated_date").datetimepicker(dtPickerOption); //03092021

    $patient_info_form.find("#forth_vaccinated_date").datetimepicker(dtPickerOption); //07022022
    ...
    $("select#vaccination_status").on("change",function(evt){
        var val = $(this).val();
        if(val == '-1' || val == '1'){
            $('select#vaccine_id option[value=-1]').prop("selected", true);            
            $("#first_vaccinated_date").data("DateTimePicker").clear();
            $("#second_vaccinated_date").data("DateTimePicker").clear();            
            $("select#vaccine_id , #first_vaccinated_date, #second_vaccinated_date").attr('disabled','disabled');

            $("#third_vaccinated_date").data("DateTimePicker").clear();
            $('select#second_vaccine_id option[value=-1]').prop("selected", true);
            $("#third_vaccinated_date, select#second_vaccine_id").attr('disabled','disabled');
            //07022022
            $("#third_vaccinated_date").data("DateTimePicker").clear(); 
            $("#forth_vaccinated_date, select#third_vaccine_id").attr('disabled','disabled');

        }else if(val == 2){            
            $("#second_vaccinated_date").data("DateTimePicker").clear();
            $("#third_vaccinated_date").data("DateTimePicker").clear(); //07022022
            ...
            $("#forth_vaccinated_date").data("DateTimePicker").clear();// 07022022
            $('select#third_vaccine_id option[value=-1]').prop("selected", true);// 07022022
            $("select#third_vaccine_id , #forth_vaccinated_date").attr('disabled','disabled'); // 07022022
            ...
            $("select#vaccine_id, #first_vaccinated_date, #second_vaccinated_date, select#second_vaccine_id, #third_vaccinated_date").removeAttr('disabled');
            ...
            $("select#vaccine_id, #first_vaccinated_date, #second_vaccinated_date, select#second_vaccine_id, #third_vaccinated_date").removeAttr('disabled');
            $("select#third_vaccine_id, #forth_vaccinated_date").removeAttr('disabled'); // 07022022
        }
    ...
    $("#btnNewPatient").on("click", function (evt) {
        ...
        $patient_info_wrapper.find("input[type=hidden]#patient-id, input[type=hidden]#patient-age, input[type=hidden]#patient-sex,input[type=hidden]#is-camlis-patient").removeData("value");
        $patient_info_wrapper.find("input[type=hidden]#patient-id, input[type=hidden]#patient-age, input[type=hidden]#patient-sex,input[type=hidden]#is-camlis-patient").removeAttr("data-value");
    ...
    $("#btnSavePatient").on("click", function (evt) {
        ...
        data.country_name	   = $patient_info_form.find("#country_name").val().trim(); // 27-05-2021
        ...
        /** 12072021 */
        data.vaccination_status     = $patient_info_form.find("select[name=vaccination_status]").val() || undefined;
        data.vaccine_id             = $patient_info_form.find("select[name=vaccine_id]").val() || undefined;        
        data.first_vaccinated_date	= $patient_info_form.find("input[name=first_vaccinated_date]").data("DateTimePicker").date() || undefined;
        data.second_vaccinated_date	= $patient_info_form.find("input[name=second_vaccinated_date]").data("DateTimePicker").date() || undefined;
        
        //03092021
        data.second_vaccine_id      = $patient_info_form.find("select[name=second_vaccine_id]").val() || undefined;        
        data.third_vaccinated_date	= $patient_info_form.find("input[name=third_vaccinated_date]").data("DateTimePicker").date() || undefined;
        
        //02072022
        data.third_vaccine_id      = $patient_info_form.find("select[name=third_vaccine_id]").val() || undefined;        
        data.forth_vaccinated_date = $patient_info_form.find("input[name=forth_vaccinated_date]").data("DateTimePicker").date() || undefined;
        ...
        if(data.third_vaccinated_date !== undefined) data.third_vaccinated_date = data.third_vaccinated_date.format('YYYY-MM-DD'); // added 03-09-2021        
        data.occupation = $patient_info_form.find("#occupation").val().trim();
        if(data.forth_vaccinated_date !== undefined) data.forth_vaccinated_date = data.forth_vaccinated_date.format('YYYY-MM-DD'); // 07022022  
       ...
       // console.log("patient_info.pid "+patient_info.pid);
       console.log(data);
        ...
        $.ajax({
            ...
            success	: function (resText) {
                ...
                if (resText.status == true && resText.patient && !resText.id_exist) {
                    ...
                    $patient_info_view.find(".country_name").text(resText.patient['country_name']);
            ...
            success: function (resText) {
                ...
                myDialog.showProgress('hide', {
                    onHidden: function () {
                        ...
                        var is_camlis_patient = (resText.is_camlis_patient == undefined) ? false : resText.is_camlis_patient;
                        if (patient) {
                            ...
                            /**
                             * Copy patient information from Lab to Lab
                             */
                            //09-06-2021                            
                            var is_patient_child = (resText.is_patient_child == undefined) ? false : resText.is_patient_child;
                            //var is_camlis_patient = (resText.is_camlis_patient == undefined) ? false : resText.is_camlis_patient;
                            if (is_patient_child || is_camlis_patient) $("#edit-patient").hide(); // hide button edit patient
                            $patient_info_wrapper.find("input[type=hidden]#is-camlis-patient").attr("data-value", is_camlis_patient);

                            if(is_camlis_patient){
                                //patient.pid = patient.patient_code; // reset pid column
                                $patient_info_wrapper.find("input[type=hidden]#patient-id").attr("data-value", patient.pid);
                            } 
                            //console.log("is_patient_child "+is_patient_child);
                            // End
    ...
    $("#edit-patient").on("click", function (evt) {
        ...
        if (patient_info) {
            ...
            //console.log("test_date "+ patient_info.test_date);
            ...
            if(patient_info.country_name){
                $patient_info_form.find("#country_name").val(patient_info.country_name); // 26-05-2021
            }else{
                $patient_info_form.find("#country_name").val(patient_info.country_name_en)
            }
            ...
            if(patient_info.vaccination_status !== null){
                $patient_info_form.find("#vaccination_status").val(patient_info.vaccination_status).change();
                if(patient_info.vaccine_id !== null) $patient_info_form.find("#vaccine_id").val(patient_info.vaccine_id).change();
                if(patient_info.first_vaccinated_date !== null){
                    var first_vaccinated_date = moment(patient_info.first_vaccinated_date).toDate();
                    $patient_info_form.find("#first_vaccinated_date").data("DateTimePicker").setDate(first_vaccinated_date);
                }
                if(patient_info.second_vaccinated_date !== null){
                    var second_vaccinated_date = moment(patient_info.second_vaccinated_date).toDate();
                    $patient_info_form.find("#second_vaccinated_date").data("DateTimePicker").setDate(second_vaccinated_date);
                }
                //03092021
                if(patient_info.third_vaccinated_date !== null){
                    var third_vaccinated_date = moment(patient_info.third_vaccinated_date).toDate();
                    $patient_info_form.find("#third_vaccinated_date").data("DateTimePicker").setDate(third_vaccinated_date);
                }
                if(patient_info.second_vaccine_id !== null) $patient_info_form.find("#second_vaccine_id").val(patient_info.second_vaccine_id).change();

                //07022022
                if(patient_info.forth_vaccinated_date !== null){
                    var forth_vaccinated_date = moment(patient_info.forth_vaccinated_date).toDate();
                    $patient_info_form.find("#forth_vaccinated_date").data("DateTimePicker").setDate(forth_vaccinated_date);
                    if(patient_info.third_vaccine_id !== null) $patient_info_form.find("#third_vaccine_id").val(patient_info.third_vaccine_id).change();
                }
            }
            $patient_info_form.find("#occupation").val(patient_info.occupation);
            //End
    ...
    if ($sample_forms.find("div.panel.sample-form.edit").length > 0) {
        ...
        //console.log(patient_info.patient_code);
        $.ajax({
                ...
                if (resText.sample_tests) {
                    for (var i in resText.sample_tests) {
                        ...
                        for (var j in samples_list) {
                            ...
                            var reject_comment = ""; // Declare variable comment_reject for store previous reject comment
                            ...
                            for (var k in samples_list[j].tests) {
                                ...
                                reject_comment = test['reject_comment']; // set the previous reject comment to varaible ject
                            ...
                            /*
                            * Find the class textarea_comment that wrape text area comment from reject modal
                            * Then store all HTML tag in clone variable
                            */
                           var $clone = $modal_rejection.find(".textarea_comment").parent();
                           $clone = $clone.clone();
                           /*
                           * Find text area name reject_comment
                           * Set the previous reject comment to it
                           * change it's id to deparment_comment_xxxx id
                           * This text area belong to deparment xxxx id
                           */
                           $clone.find('textarea[name="reject_comment"]').html(reject_comment).prop('id', "dept_comment_" + department_sample_id);
                           /*
                           * Find the class show-reject-comment-modal button then set it's id 
                           * with value department id
                           * when user click this button we will know this comment will belong to department id
                           */
                           $clone.find('.show-reject-comment-modal').prop('id', department_sample_id);
                           // Add this text area comment to modal
                           test_list += $clone.html();
                            test_list += "</div>";
                            test_list += "</div>";
                            test_list += "</div>";
                        }
    ...
    $modal_rejection.find("#btnAddRejection").on("click", function (evt) {
        ...
        */
       data.reject_comment      = []; // 29/08/2018 Change this variable to array
       data.reject_sample		= $modal_rejection.find("input:checkbox#reject_sample:checked").length;
       data.reject_tests		= []; 
       /*
       * 29/08/2018 Set value to data.reject_comment
       * Find all department checkbox then
       * Find all text area comment in each department
       * Get value from each department and text area
       * Push it to data.reject_comment
       */
        $test_list.find('input:checkbox[name="department_sample"]').each(function() {
            var comments = new Object();
            //coments['dept_id', 'comment'] = comment_text_area (find the id of row form-group test-group)
            comments = {
                "department_sample_id": $(this).val(),
                "reject_comment": $("#"+$(this).val()).find('textarea[name="reject_comment"]').val()
            }
            data.reject_comment.push(comments);
        });
    ...
    $modal_rejection.on("click", "button.show-reject-comment-modal", function(evt) {
        ...
        /*
        * Find the class add-reject-comment
        * Set department id data with value that get department id of show-reject-comment-modal button
        */
        var department_id = $(this).prop('id');
        //console.log("department ID: "+ department_id);
        $modal_reject_comment.find('button.add-reject-comment').data('department_id', $(this).prop('id'));
    ...
    $modal_reject_comment.on("click", "button.add-reject-comment", function () {
        ...
        /*
        * Find the text area with id dept_comment_xxxx
        * Set value to text area
        */
        $modal_rejection.find("textarea#dept_comment_"+$(this).data('department_id')).val(comment.join("\r\n"));
        /*
        * 29/08/2018 
        * Old code
   ...
   $print_preview_modal.on('click', '#approve', function(event) {
    ...
    $sample_forms.on("click", ".btnShowTestModal", function (evt) {
         ...
         * Is Camlis Patient
         */
        if(data.is_camlis_patient){
            //console.log("Before "+data.patient_id);
            //console.log($("div#patient-info-wrapper").find("input[type=hidden]#patient-id").data("value"));
            data.patient_id = $("div#patient-info-wrapper").find("input[type=hidden]#patient-id").data("value");
            //console.log("After: "+data.patient_id);
        }
                ...
                if (resText.sample_details && Array.isArray(resText.sample_details) && resText.sample_details.length > 0) {
                    for (var i in resText.sample_details) {
                        ...
                        if ($department_sample != undefined) {
                            //console.log(resText.sample_details);
    ...
    $sample_forms.on("click", ".btnAddResult", function (evt) {
        ...
        $.ajax({
            ...
            success	 : function (resText) {
                ...
                $test_list.find("input.test_time").timepicker({minuteStep: 1, showMeridian: false, defaultTime: ''}); //16072021
                //Init Select2
                ...
                if (resText.result_comment) {
                    for(var i in resText.result_comment) {
                        ...
                        /*29/08/2018 Add new reject text area for prevouse reject comment*/
                        $modal_result.find("textarea#reject-comment-" + resText.result_comment[i].department_sample_id).val(resText.result_comment[i].reject_comment);
                    }
                }
                ...
                $test_list.find("tr[data-rejected=false]").each(function () {
                   ...
                   if (is_rejected == true) return true;
                    ...
                    if (resText.results && resText.results[patient_test_id] != undefined) {
                        ...
                        //19072021
                        var $inputTestTime = $(this).find("td input.test_time");
                        
                        if(resText.results[patient_test_id].test_time !== null){
                            $inputTestTime.timepicker('setTime', moment(resText.results[patient_test_id].test_time, 'HH:mm:ss').format('HH:mm'));
                        }

                        //$item.find("input.rectimepicker").timepicker('setTime', moment(sampleFormData.received_time, 'HH:mm:ss').format('HH:mm'));
                        
                        //Machine result
                        (resText.results[patient_test_id].machine_name != "") ? $(this).find(".machine").data('machine-name', resText.results[patient_test_id].machine_name).html(resText.results[patient_test_id].machine_name) : "";
                        ...
                        if ([1, 2].indexOf(field_type) > -1) {
                            ...
                            //30032022
                            if ($(this).find("span.reason_update").attr('patient_test_id') == resText.results[patient_test_id].patient_test_id ) {
                                $(this).find("span.reason_update").css({'color':'blue', 'cursor':'pointer','display':'block'});                                
                            }
                            //End
                ...
                $test_list.find("tr.test").each(function() {
                    ...
                    */
                   //console.log('resText.patient_sample.verify '+resText.patient_sample.verify )
                ...
                for (var i = keys.length - 1; i >= 0; i--){
                    $test_list.find("tr.test").each(function() {
                        console.log("Number update: "+ resText.results[keys[i]].number_update);
                            ...
                            $(this).find("span.t-name").qtip({
                                ...
                                content: {
                                    text: function(event, api) {
                                        ...
                                        .then(function(data) {
                                            var content = "<table class='table table-bordered table-striped' style='width:100%; !important'><thead><tr><th>User</th><th>From</th><th>To</th><th>Qty</th><th>Date</th><th>Comment</th></thead><tbody>";
                                            $.each(data, function(index, result) {
                                                comment = result.reason_comment == null ? '' : result.reason_comment;
                                                content+= "<tr><td>" + result.fullname + "</td><td>" + result.from_result + "</td><td>" + result.to_result + "</td><td>" + result.quantity + "</td><td>" + result.modified_date + "</td><td>"+comment+"</td></tr>";
                                            });
                                            content+= "</tbody></table>";
                ...
                */
                $test_list.find("tr[data-field-type=1]").each(function() {
                    ...
                    if($(this).attr('data-sample-test-id') === "126" || $(this).find("td .t-name").html() === "H.I.V antibody (Determine)"){
                        ...
                        */
                        $(this).find("td input.test_date").attr('id', 'test_date_determine').on('dp.change', function(event) {
                            ...
                            $('#test_date_combo').val($(this).val()).trigger('change'); //14032022
                        });
                        /*
                        ...
                        */
                        $(this).find("td .performer").attr('id', 'performer_determine').on('change', function(event) {
                            ...
                            $('#performer_combo').val($(this).val()).change(); //14032022
                        });
                    ...
                    if($(this).attr('data-sample-test-id') === "128" || $(this).find("td .t-name").html() === "H.I.V antibody (UNIGOLD)"){
                        ...
                        $(this).find("td input.result").on('change', function(event) {
                            ...
                            if($(this).val() === "Reactive" && $('#start_pak').val() === "Reactive"){
                                ...
                                result = [];
                                result.push({
                                    test_organism_id	: 4705,
                                    quantity_id			: '-1',
                                    contaminant         : 0,
                                    antibiotic			: {antibiotic_id: undefined, sensitivity: undefined, disc_diffusion: undefined, test_zone: undefined, invisible: false},
                                    length: 1
                                });
                                $("#combo").data("possible_result", result);
                                $('#combo').val("Reactive"); //14032022
                                /**
                                 * 27052022
                                 *  Hide HIV Combo in case its result Reactive
                                 *  if antibody elementn exist we need to hid HIV combo
                                */
                                 if($('#antibody').length){
                                    console.log("Antibody exist");
                                    $('#test-visibility_combo').prop('checked', true).change();                                    
                                    $('#icheckbox_minimal_combo').attr('class', 'icheckbox_minimal checked');
                                }
                    ...
                    */
                    ...
                    if($(this).attr('data-sample-test-id') === "412" || $(this).find("td .t-name").html() === "H.I.V Combo"){
                        /*change id to combo*/
                        $(this).find("td input.result").attr('id', 'combo');                        
                        /*check if the result is number then set it value to empty*/
                        /*Set id to test-visibility_combo*/
                        $(this).find("td input.test-visibility").attr('id', 'test-visibility_combo');
                        /*Set id to icheckbox_minimal_combo*/
                        $(this).find("td .icheckbox_minimal").attr('id', 'icheckbox_minimal_combo');
                        if($.isNumeric($(this).find("td input.result").val())){
                            $(this).find("td input.result").val("");
                        }
                        /*Find the text field test_date of combo and set it's id*/
                        $(this).find("td input.test_date").attr('id', 'test_date_combo');
                        /*Find the performer of combo and set it's id*/
                        $(this).find("td .performer").attr('id', 'performer_combo');
                        // 27052022
                        $(this).find("td input.result").on('change', function(event) {
                            event.preventDefault();
                            if($(this).val() === "Non Reactive"){
                                ...
                                result = [];
                                result.push({
                                    test_organism_id	: 4706,
                                    quantity_id			: '-1',
                                    contaminant         : 0,
                                    antibiotic			: {antibiotic_id: undefined, sensitivity: undefined, disc_diffusion: undefined, test_zone: undefined, invisible: true},
                                    length: 1
                                });
                                $("#combo").data("possible_result", result);
                                $('#combo').val("Non Reactive");
                            }else{
                                $('#antibody').val("");
                                $('#test-visibility_combo').prop('checked', false ).change();
                                $('#icheckbox_minimal_combo').attr('class', 'icheckbox_minimal unchecked');
                            }
                        })
                    }
                ...
                $test_list.find("tr.test").each(function() {                    
                    ...
                    //Machine event
                    var $reasn_update = $(this).find(".reason_update");
                    $reasn_update.click(function(event) {
                        event.preventDefault();
                        var $patient_test_id = $(this).attr('patient_test_id');
                        //console.log($patient_test_id);
                        var comment_val = $("#input_reason_comment_"+$patient_test_id).val();
                        $input = $modal_reason_comment.find("#reason_comment");
                        $input.val(comment_val);
                        $input.attr('patient_test_id',$patient_test_id);
                        $modal_reason_comment.modal('show');
                    });    
                });
                // End 
    ...
    $modal_result.find(".btnSaveResult").on("click", function (evt, callback) {        
        ...
        $test_list.each(function () {
            ...
            var $inputTestDate  = $(this).find("td input.test_date");
            var $inputPerformer = $(this).find("td select.performer");
            var $inputTestTime  = $(this).find("td input.test_time");//19072021
            var $inputComment   = $(this).find("span input.value_comment"); //30032022
            ...
            var test_time		= $inputTestTime.val();
            var reason_comment  = $inputComment.val(); //30032022
            //console.log("Reason comment = "+reason_comment);
            ...
            var machine         = ($(this).find(".machine").data('machine-name') != undefined) ? $(this).find(".machine").data('machine-name') : "";
            ...
            var row_data = {
                ...
                test_time       : test_time == "" ? "" :  moment(test_time, "HH:mm").format('HH:mm:ss'),
                performer_id	: performer,
                machine_name    : machine,
                result			: null,
                reason_comment  : reason_comment //30032022
            };
     ...
     * Date:  16092022
     */
     $("#btn-choose-datetime").on("click", function (evt) {
        evt.preventDefault();
        var val = $("#date_picker_comment").val();
        if(val != ''){
            var datetime_picker = $("#date_picker_comment").data("DateTimePicker").date();
            datetime_picker_obj = moment(datetime_picker);
            datetime_picker = datetime_picker_obj.format("DD/MM/YYYY");
            time = datetime_picker_obj.format("HH:mm");
            
            var department_sample_id = $("#modal-datepicker").data("department_sample_id");
            ...
            fulldate = 'Date: '+ datetime_picker+ ' at '+ time;            
            cmt.val(old_val + fulldate + "\r\n");
        }
     ...
     * 30032022
     */
    $("#btnAddReasonComment").on("click", function (evt) {
        evt.preventDefault();

        //var department_sample_id = $("#modal-comment").data("department_sample_id");
        var cmt		= $modal_reason_comment.find("#reason_comment");
        var $patient_test_id = cmt.attr('patient_test_id');        
        //console.log(cmt.val());
        $("#input_reason_comment_"+$patient_test_id).val(cmt.val());
        $modal_reason_comment.modal("hide");
    });
    ...
    $sample_forms.on("click", ".btnPreviewCovidForm", function (evt) {
        ...
        $print_preview_covid_form_modal.data("patient_sample_id", data.patient_sample_id);
    ...
    $print_preview_covid_form_modal.on("hidden.bs.modal", function () {
        $print_preview_covid_form_modal.find(".modal-dialog").empty();
    });
...
function showPossibleResult(input) {
    ...
    for (var i in prev_result) {        
        prev_organism['org_' + prev_result[i].test_organism_id ] = { test_organism_id : prev_result[i].test_organism_id, quantity_id : prev_result[i].quantity_id, contaminant : prev_result[i].contaminant };
    ...
    setTimeout(function() {
        ...
        $.ajax({
            ...
            success	: function (resText) {                
                ...
                var contaminant = "<input type='checkbox' name='contaminant' value='' class='form-control contaminant'>";
                ...
                for (var i in resText) {
                    ...
                    data.push({
                        DT_RowData		: { 
                            test_organism_id : resText[i].test_organism_id,
                            organism_id: resText[i].organism_id
                        },
    ...
    $possible_result_modal.find(".modal-footer #btnAddOrganism").off("click").on("click", function (evt) {
        ...
        $organism_list.find("tr").each(function () {
            if ($(this).find("td input.test_organism").is(":checked")) {
                ...
                var contaminant = $(this).find("td .contaminant").is(":checked") ? 1 : 0 ;
        ...
        //console.log('btnAddOrganism clicked: ');
        //console.log(result);
        ...
        if (data.length > 0) {
            ...
            for(var i in data) {
                ...
                dtData.push({
                    ...
                    disc_diffusion  : "<input type='text' class='form-control disc_diffusion' data-antibiotic='"+data[i].antibiotic_id+"' size='3'>",
                    test_zone       : "<input type='text' class='form-control test_zone' data-antibiotic='"+data[i].antibiotic_id+"' size='3'>",
                    invisible		: "<input type='checkbox' class='form-control invisible-antibiotic' value='true'>"
                });
            }
            ...
            // require diffusion and test zone tr click
            $list.find("tr").each(function () {
                // select sensitivity object
                var sensitivity = $(this).find("td select.sensitivity");
                // select diffusion object
                var disc_diffusion  = $(this).find("td input.disc_diffusion");
                // select test_zone object
                var test_zone = $(this).find("td input.test_zone");
                // Check if sensitivity select change
                sensitivity.change(function(event) {
                    // change disc_diffusion border to red
                    disc_diffusion.css('border-color', 'red');
                    // change test_zone border to red
                    test_zone.css('border-color', 'red');
                    // Bring cursor to disc_diffusion
                    disc_diffusion.focus();
                    // check sensitivity value
                    if(sensitivity.val() === "-1") {
                        // chnage diffusion border to normal
                        disc_diffusion.css('border-color', '');
                        // chnage test_zone border to normal
                        test_zone.css('border-color', '');
                        // clear diffusion value
                        disc_diffusion.val('');
                        // clear test_zone value
                        test_zone.val('');
                    } 
                });
                // Event diffusion
                disc_diffusion.keyup(function(event) {
                    //console.log("disc diffuction event");
                    //console.log($(this).val())
                    if (Number($(this).val())) {
                        test_zone.val('');
                        $.ajax({
                            url: base_url + "interpretation/get_antibiotic_rank",
                            type: 'POST',
                            dataType: 'json',
                            data: {
                                test_organism_id: $possible_result_modal.data('test_organism_id'),
                                antibiotic_id: $(this).data('antibiotic'),
                                diffusion: $(this).val(),
                                test_zone: test_zone.val()
                            },
                            success: function(response){
                                (response) ? sensitivity.val(response.description) : sensitivity.val(-1);
                            }
                        });
                    }
                });
                // Event test_zone
                test_zone.keyup(function(event) {
                    if (Number($(this).val())) {
                        disc_diffusion.val('');
                        $.ajax({
                            url: base_url + "interpretation/get_antibiotic_rank",
            ...
            //set previous selected antibiotic
            //('antibiotic_result '+ JSON.stringify(antibiotic_result));
            for (var i in antibiotic_result) {
                $tr = $list.find("tr[id=anti_" + antibiotic_result[i].antibiotic_id + "]");
                if ($tr.length > 0) {
                    if(antibiotic_result[i].invisible == true){
                        //("check : "+antibiotic_result[i].invisible);
                    }
                    else{
                        //console.log("uncheck : "+antibiotic_result[i].invisible);
                    }
                    
                    $tr.find("td select.sensitivity").val(antibiotic_result[i].sensitivity)
                    $tr.find("td input.disc_diffusion").val((Number(antibiotic_result[i].disc_diffusion) != 0) ? antibiotic_result[i].disc_diffusion : '');
                    $tr.find("td input.test_zone").val(antibiotic_result[i].test_zone);
                    $tr.find("td :checkbox.invisible-antibiotic").iCheck(antibiotic_result[i].invisible == true ? 'check' : 'uncheck');
                }
            }
        } else {
...
function getSelectedAntibiotic() {
    ...
    $list.find("tr").each(function () {
        ...
        var disc_diffusion  = $(this).find("td input.disc_diffusion").val();
        var test_zone		= $(this).find("td input.test_zone").val();
        if($(this).find(":checkbox.invisible-antibiotic:checked").val() == "true"){
            var v = true;
        }else{
            v = false;
        }
        // it return as string so it make error when comparation....
        // added: 13 02 2021
        //var invisible       = $(this).find(":checkbox.invisible-antibiotic:checked").val() || false;
        var invisible       = v;
        if (sensitivity != -1) {
            selected.push({
                antibiotic_id	: antibiotic_id,
                sensitivity		: sensitivity,
                disc_diffusion	: disc_diffusion,
                test_zone		: test_zone,
                invisible       : invisible
            });           
        }
        //console.log(n+")invisible");
        //console.log($(this).find(":checkbox.invisible-antibiotic:checked").val());
        n++;
    });
    ...
    return $organism_list.DataTable({
        ...
        createdRow		: function(row, data, dataIndex) {
            ...
            if (prev_organism['org_' + $(row).data("test_organism_id")] != undefined) {
                ...
                prev_organism['org_' + $(row).data("test_organism_id")].contaminant == 1 ? $(row).find("input.contaminant").prop( "checked", true ) : '';
            }
            ...
            $(row).on("click", function (evt, selectRow, action) {
                /*set organism id to the possible result modal*/
                $possible_result_modal.data('test_organism_id', $(row).data("test_organism_id"));
                ...
                //console.log(selectedAntibiotic);
                ...
                /*alert organism warning message*/
                /*
                $.ajax({
                    url: base_url + "organism/alert_warning_message",
                    type: 'POST',
                    dataType: 'json',
                    data: {id: $(this).data("organism_id")},
                    success: function(response){
                        if (typeof response[0] !== 'undefined' && response[0].alert)
                        myDialog.showDialog('show', { text  : response[0].alert, style: 'warning' });
                    }
                });
                */
            });
...
function init_AntibioticTable() {
    return $("#possible_result_modal").find("table#antibiotic_list").DataTable({
        ...
        columnDefs		: [
            ...
            {targets : 2, width : '40px', className : 'text-center text-middle'},
...
function SampleForm(form) {
    ...
    this.get_data = function () {
        ...
        var is_camlis_patient       = $("div#patient-info-wrapper").find("input[type=hidden]#is-camlis-patient"); // added 09-06-2021
        ...
        data.is_camlis_patient    = is_camlis_patient == undefined ? "" : is_camlis_patient.data("value");// added 09-06-2021
        ...
        data.phone_number                   = this.form.find("input[name=phone_number]").val() == undefined ? "" : this.form.find("input[name=phone_number]").val().trim();        
        data.sample_collector               = this.form.find("input[name=sample_collector]").val() == undefined ? "" : this.form.find("input[name=sample_collector]").val().trim();
        ...
        data.number_of_sample	            = this.form.find("select[name=number_of_sample]").val() == 0 ? 0 : this.form.find("select[name=number_of_sample]").val(); // added 20-04-2021
        data.health_facility                = this.form.find("input[name=health_facility]").val() == undefined ? "" : this.form.find("input[name=health_facility]").val().trim();
        // End
        return data;
    };
    ...
    this.validate_date_time = function () {
        ...
        if (col_timestamp > 0 && rec_timestamp > 0 && col_timestamp > rec_timestamp) is_valid = false; // update 26-04-2021
    ...
    this.validate_fields = function () {
       ...
       // if (data.for_research == 0) is_valid = false; // 22-05-2021

        //console.log(data.for_research);
        ...
        $.ajax({
            ...
            success		: function (resText) {
                ...
                if (resText.status === true) {
                    ...
                    /**
                     * 08-07-2021
                     * If it is camlis patient
                     */
                    if(resText.is_camlis_patient){
                        patient_info.pid = resText.data.patient_id; // save to global
                        $("input[type=hidden]#patient-id").data("value", resText.data.patient_id);
...
function ResultForm() {
        ...
        if (tests) {
            ...
            for (var i in tests) {      
                ...
                if (tests[i].is_rejected == 1) {
                    html += "<td colspan='7'>" + msg_test_rejected + "</td>";
                } else {
                    
                    html += "<td>" + input +"</td>";
                    //22032022
                    comment = "<span class='reason_update' patient_test_id='"+tests[i].patient_test_id+"' style='display:none;' ><a href='javascript:void(0);' class='reason_comment'><i class='fa fa-comments-o'></i></a><span> <input type='hidden' id='input_reason_comment_"+tests[i].patient_test_id+"' class='form-control value_comment' name='reason_comment' />";
                    //End
                    if (is_heading){
                        comment = '&nbsp;';
                        html += "<td style='width:10px;'>";
                    } 
                    html += "<td style='width:10px;'>" + comment +"</td>";
                    html += "<td style='width:100px;' class='unit-sign'>" + unit_sign + "</td>";
                    html += "<td style='width:120px;' class='ref-range'>" + ref_range + "</td>";
                    html += "<td style='width:10px; position:relative;'>";
                    
                    if (!is_heading) html += "<input type='text' class='form-control test_date' style='background:white;' ></td> <td style='width:10px; position:relative;'><input type='text' style='display:none;' class='form-control test_time' name='test_time' /></td>";
        ...
        for (var d in data) {
            ...
            if (data[d].samples) {
                ...
                for (var s in data[d].samples) {
                    ...
                    html += "<tr style='border-left: 2px solid #9078cf;' id='dsample-"+ department_id +"-"+ sample_id +"'><td colspan='9'><b class='text-blue'>" + group_name + "</b>";
                    html += "&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp;";
                    ...
                    */
                    ...
                    html += "<td align='right' ><button type='button' class='btn btn-primary btn-sm' onclick='onSelectComment("+data[d].department_id+","+data[d].samples[s].sample_id+","+data[d].samples[s].department_sample_id+");' >Select Comment</button> <br /> <a href='javascript:void(0);' onclick='onSelectDatetime("+data[d].samples[s].department_sample_id+")' class='datepicker_icon' title='Extend date time' ><i class='fa fa-calendar'></i></a></td>";
                    html += "<td colspan='7'><textarea name='result_comment' id='result-comment-"+ data[d].samples[s].department_sample_id +"' class='form-control' style='margin-top: 0; margin-bottom: 0; height: 80px; resize:none;'></textarea></td>";
                    html += "</tr>";
                } //end loop of samples
            }
    ...
    // 16092022
    onSelectDatetime = function(department_sample_id){        
        console.log(department_sample_id);
        var $modal_datepicker = $("#modal-datepicker"); //16092022       
        $modal_datepicker.data("department_sample_id", department_sample_id); 
        $("#date_picker_comment").val("");
        $("#date_picker_comment").datetimepicker({
            widgetPositioning : {
                horizontal	: 'left',
                vertical	: 'bottom'
            },
...
function addSampleForm(initValue, $sampleForm, sampleFormData) {
    ...
    if ($item) {        
        ...
        //Reason for testing
        /*
        $item.find("select[name=for_research]").on("change", function () {
            sampleForm.validate_fields();
            sampleForm.validate_date_time();
        });
        */
    ...
    if (sampleFormData) {
        ...
        if( (sampleFormData.completed_by !== "") || (sampleFormData.phone_number !== "") || (sampleFormData.phone_number_sample_collector !== "") || (sampleFormData.sample_collector !== "") || (sampleFormData.clinical_symptom !== undefined)){ 
            $('#collapseCovidForm'+count).collapse();
        }
        ...
        var number_of_sample = (sampleFormData.number_of_sample == null || sampleFormData.number_of_sample == "" || sampleFormData.number_of_sample == undefined) ? 0 : sampleFormData.number_of_sample;       
        $item.find("select[name=number_of_sample]").val(number_of_sample).trigger("change");
        $item.find("input[name=health_facility]").val(sampleFormData.health_facility);
    }
}