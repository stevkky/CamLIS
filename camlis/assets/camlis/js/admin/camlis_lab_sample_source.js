$(function() {
    ...
    var tbl_sample_source = $("#tbl-sample-source").DataTable({
        ...
        "serverSide" : true,
        "ajax"       : {
            "url"    : base_url+'sample_source/view_lab_sample_source',
            "type"   : 'POST'
        },
    ...
    $("#btnSave").on("click", function(evt) {
        ...
        var url     = base_url + "sample_source/add_lab_sample_source";
        ...
        if (ID > 0) url = base_url + "sample_source/update_lab_sample_source";
    ...
    $("#tbl-sample-source").on("click", ".remove", function(evt) {
        ...
        if (confirm(q_delete_sample_source)) {
            $.ajax({
                url      : base_url + 'sample_source/delete_lab_sample_source',
                type     : 'POST',
